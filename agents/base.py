...
try:
    from anchor import guard, enforce
except ImportError:
...
class BaseWorker(ABC):
    ...
    @guard(domain="animus_agentic_mesh")
    @enforce(disclosure="AI Generated by Animus Studio Agent Engine", domain="animus_agentic_mesh")
    async def run(
        self,
